Ti=Déclarations du {_Cédant} concernant la gestion de la Société depuis le {DateDeReference.Gestion.YMD} 

0.sec=Le {_Cédant} déclare et garantit qu’entre le {DateDeReference.Gestion.YMD} et ce jour, date rétroactive du transfert de propriété des Actions :
...
7.sec=Toutes les rémunérations, y compris celles des mandataires sociaux, sont demeurées inchangées et aucune promesse d’augmentation ou d’embauche n’a été consentie sans l’accord du {_Cessionnaire}.
